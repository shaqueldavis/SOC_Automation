...
Open the start menu then type in "Powershell". Right click on Powershell and open it as an administrator.
...
I also typed `ls`, is an alias for Powershell's native command `GetChildItem` to reveal the contents of the folder and confirm I'm in the right place.
...
Initiate the installation of Sysmon by typing the following into powershell:
```
...
<img width="1828" height="484" alt="image" src="https://github.com/user-attachments/assets/8fa33848-8efd-49f9-845a-470dd4ee070a" />
...
### Phase [08. Wazuh Cloud Instance](08.%20Wazuh%20Cloud%20Instance.md)
