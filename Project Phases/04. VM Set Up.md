...
Keep the default of “only files needed to support a TPM are encrypted…”. Encrypting all files could make moving, recovering, or troubleshooting the VM less convenient. <br>
...
You may also notice a yellow bar across the bottom of the screen. Ignore it until you are finished installing everything.
...
### Phase [05. Windows Set Up](05.%20Windows%20Set%20Up.md)
